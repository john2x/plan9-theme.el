...
;;;;; erc
   ...
   `(erc-nick-default-face ((t (:foreground ,fg :background ,bg-dark :weight bold))))
   `(erc-my-nick-face ((t (:foreground ,cyan :background ,cyan-light :weight bold))))
...
;;;;; Org
   ...
   `(org-level-8 ((t (:background ,bg-alt :foreground ,fg-alt))))
